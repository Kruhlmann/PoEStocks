...
function search_results_to_html(results){
    ...
    for(var i = 0; i < results.length; i++){
        html += '<a href="#"><li class="result result-final"><img src="static/img/currency/' + currencies[results[i]]["name"] + '.png"></img><span>' + currencies[results[i]]["display_name"] + '</span></li></a>'
    }
    return html;
}
